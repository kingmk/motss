...
var nicEditorConfig = bkClass.extend({
	...
	buttonList : ['save','bold','italic','underline','left','center','right','justify','ol','ul','fontSize','fontFamily','fontFormat','indent','outdent','image','upload','link','unlink','forecolor','bgcolor', 'emotion', 'video', 'music'],
	iconList : {"xhtml":1,"bgcolor":2,"forecolor":3,"bold":4,"center":5,"hr":6,"indent":7,"italic":8,"justify":9,"left":10,"ol":11,"outdent":12,"removeformat":13,"right":14,"save":25,"strikethrough":16,"subscript":17,"superscript":18,"ul":19,"underline":20,"image":21,"link":22,"unlink":23,"close":24,"arrow":26,"upload":27, "emotion":28, "video":29, "music":30}
...
var nicLinkOptions = {
	buttons : {
		'link' : {name : '超链接', type : 'nicLinkButton', tags : ['A']},
		'unlink' : {name : '取消链接',  command : 'unlink', noActive : true}
	}
};
/* END CONFIG */
...
var nicEmotionOptions = {
	buttons : {
		'emotion' : {name :  __('表情'), type : 'nicEmotionButton'}
	}
...
var nicMediaOptions = {
	buttons : {
		'video' : {name :  __('视频'), type : 'nicVideoButton'},
		'music' : {name :  __('音乐'), type : 'nicMusicButton'}
	}
...
var nicMusicButton = nicEditorAdvancedButton.extend({	
	addPane : function() {
		this.im = this.ne.selectedInstance.selElm().parentTag('IMG');
		this.addForm({
			'' : {type : 'title', txt : 'Add/Edit Image'},
